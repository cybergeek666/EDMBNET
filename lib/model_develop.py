...
#
        ...
        if epoch > 1 and epoch < args.begin_epoch:
            ...
            # EQ.12 13 in paper
            label_disttribution = torch.tensor(label_disttribution).float()  #YO
            if epoch > 1:
        ...
        if epoch == args.begin_epoch:
            ...
            print("11111111111111",weak_combintaions)
            weak_combintaions = torch.tensor(weak_combintaions)
